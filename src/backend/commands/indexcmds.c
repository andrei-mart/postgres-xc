			...
			bool quiet)
{
	...
	if (IS_PGXC_COORDINATOR)
	{
		...
		/*
		 * Koichi:
		 * In 9.2.3 merge, I found exclusionOpNames is now not included in the function
		 * argument.  Because XC does not support exclusion constraint, it will be
		 * safe enough to assume exclusionOpNames is NULL.
		 *
		 * May need further consideration when we support exclusion constraint.
		 */
